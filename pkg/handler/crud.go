...
import (
	...
	"github.com/openflagr/flagr/pkg/notify"
...
func (c *crud) PutFlag(params flag.PutFlagParams) middleware.Responder {
	...
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.UPDATED, notify.FLAG, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) SetFlagEnabledState(params flag.SetFlagEnabledParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.TOGGLED, notify.FLAG, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) DeleteFlag(params flag.DeleteFlagParams) middleware.Responder {
	f := &entity.Flag{}
	if err := getDB().First(f, params.FlagID).Error; err == nil {
		notify.All(getDB(), util.SafeUint(params.FlagID), notify.DELETED, notify.FLAG, getSubjectFromRequest(params.HTTPRequest))
	}
...
func (c *crud) DeleteTag(params tag.DeleteTagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.DELETED, notify.TAG, getSubjectFromRequest(params.HTTPRequest))
...
func (c *crud) CreateTag(params tag.CreateTagParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.CREATED, notify.TAG, getSubjectFromRequest(params.HTTPRequest))
...
func (c *crud) CreateSegment(params segment.CreateSegmentParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.CREATED, notify.SEGMENT, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) PutSegment(params segment.PutSegmentParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.UPDATED, notify.SEGMENT, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) DeleteSegment(params segment.DeleteSegmentParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.DELETED, notify.SEGMENT, getSubjectFromRequest(params.HTTPRequest))
...
func (c *crud) CreateConstraint(params constraint.CreateConstraintParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.CREATED, notify.CONSTRAINT, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) PutDistributions(params distribution.PutDistributionsParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.UPDATED, notify.DISTRIBUTION, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) CreateVariant(params variant.CreateVariantParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.CREATED, notify.VARIANT, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) PutVariant(params variant.PutVariantParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.UPDATED, notify.VARIANT, getSubjectFromRequest(params.HTTPRequest))
	return resp
}
...
func (c *crud) DeleteVariant(params variant.DeleteVariantParams) middleware.Responder {
	...
	entity.SaveFlagSnapshot(getDB(), util.SafeUint(params.FlagID), getSubjectFromRequest(params.HTTPRequest))
	notify.All(getDB(), util.SafeUint(params.FlagID), notify.DELETED, notify.VARIANT, getSubjectFromRequest(params.HTTPRequest))
